      ...
      >
        <div className="container relative">
          <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-6 gap-[30px] relative">
            <div
              className={`order-1 md:${isRTL ? "ms-6" : "me-6"} md:order-[-1]`}
            >
            ...
            <div className="relative">
              ...
              />
              <div
                className={`overflow-hidden absolute md:size-[500px] size-[400px] bg-gradient-to-tl to-[#FF97FF]/20 via-[#9761FF]/70 from-[#9761FF] bottom-1/2 translate-y-1/2 ${
                  isRTL
                    ? "md:end-0 end-1/2 md:translate-x-0 translate-x-1/2"
                    : "md:start-0 start-1/2 md:translate-x-0 -translate-x-1/2"
                } z-1 shadow-md shadow-red-500/10 rounded-full`}
              ></div>
